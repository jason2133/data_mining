...
# Reading Data
BNKSERV = read.transactions("C:/Users/jason/¹ÙÅÁ È­¸é/coding1/data_mining/Assignment/Assignment_1_Association Analysis/BNKSERV.csv", format = "single", cols = c(1,2), sep=",", skip=1, rm.duplicate=TRUE)
inspect(BNKSERV)
